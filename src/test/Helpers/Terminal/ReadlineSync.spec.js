...
suite('Helpers/Terminal/ReadlineSync', () => {
  let options = {
    option: 'Test option',
  };
  ...
  test('Check constructor sets valid value for _options', () => {
    readlineSync = new ReadlineSync(options);
    chai.expect(readlineSync.options).to.be.eql(options);
  });

  test('Check createInterface() without args returns valid instance of ReadlineSync', () => {
  ...
  test('Check createInterface() returns valid instance of ReadlineSync', () => {
  ...
  test('Check question() return valid instance of ReadlineSync', () => {
  ...
  test('Check questionHidden() return valid instance of ReadlineSync', () => {
    let spyCallback = sinon.spy();
