...
suite('Provisioning/Service/APIGatewayService', () => {
  ...
  test(`Check name() method returns \'${Core.AWS.Service.API_GATEWAY}\'`, () => {
  ...
  test('Check AVAILABLE_REGIONS() static method returns array of available regions', () => {
    ...
    chai.expect(APIGatewayService.AVAILABLE_REGIONS).to.be.include(Core.AWS.Region.EU_FRANKFURT);
  ...
  test('Check getJsonResponseTemplate() method returns {\'application/json\':\'\'}', () => {
    let expectedResult = {
      'application/json': '',
    };
  ...
  test('Check getJsonResponseTemplate() method returns valid object', () => {
    let expectedResult = {
  ...
  test('Check jsonEmptyModel getter returns valid { "application/json": "Empty" }', () => {
    let expectedResult = {
  ...
  test('Check _getMethodResponseParameters() method returns response parameters', () => {
    let e = null;
    let actualResult = null;
    let httpMethod = 'GET';
    let expectedResult = {
  ...
  test('Check _getMethodRequestParameters() method returns request parameters', () => {
    let e = null;
    let actualResult = null;
    let httpMethod = 'GET';
  ...
  test('Check _methodParamsGenerator() method returns valid array', () => {
    let e = null;
    let actualResult = null;
  ...
  test('Check _extractApiResourcesMetadata() method returns valid array', () => {
    let e = null;
    let actualResult = null;
    let expectedResult = {
      'src/Test/Create': {
  ...
  test('Check getAllEndpointsArn() method returns valid array', () => {
    let e = null;
    let actualResult = null;
